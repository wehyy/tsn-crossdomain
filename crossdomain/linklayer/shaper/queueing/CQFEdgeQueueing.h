...
#ifndef CROSSDOMAIN_LINKLAYER_SHAPER_QUEUEING_CQFEDGEQUEUEING_H_
#define CROSSDOMAIN_LINKLAYER_SHAPER_QUEUEING_CQFEDGEQUEUEING_H_

#include <omnetpp.h>

//#include "IEEE8021QCQF/linklayer/shaper/queueing/CQFQueueing.h"
#include <omnetpp.h>
...
namespace CoRE4INET {
    class CQFEdgeQueueing : public virtual cSimpleModule {
    private:
        /**
...
#endif /* IEEE8021QCQF_LINKLAYER_SHAPER_QUEUEING_CQFEDGEQUEUEING_H_ */
